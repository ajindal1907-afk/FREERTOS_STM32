...
|---|--------|-------|----------|
| 01 | `EXP1` | GPIO Digital Output — LED Blink | GPIO Output, Software Delay |
| 02 | `EXP2` | GPIO Digital Input — Push Button LED Toggle | GPIO Input, Debouncing |
| 03 | `EXP3` | HC-SR04 Ultrasonic Sensor — Distance Classification | GPIO, Timer, USART, Sensor Interfacing |
| 04 | `EXP4` | PWM LED Brightness Control | Timer, PWM, Duty Cycle |
| 05 | `EXP5` | FreeRTOS — LED Blink via Single Task | FreeRTOS, Task Creation, vTaskDelay |
| 06 | `EXP6` | FreeRTOS — Dual Task Priority Analysis | FreeRTOS, Task Priority, Preemption |
| 07 | `EXP7` | FreeRTOS — Dual Task Priority with SWV ITM Tracing | FreeRTOS, CMSIS-V2, SWV ITM Console, Priority Scheduling |
| 08 | `EXP8` | FreeRTOS — Binary Semaphore with EXTI Button Interrupt | FreeRTOS, Binary Semaphore, EXTI, Deferred Interrupt Processing |
| 09 | `EXP9` | *(Coming Soon)* | — |
| 10 | `EXP10` | *(Coming Soon)* | — |
...
> This experiment will be added soon. Stay tuned!
...
```bash
git clone https://github.com/<your-username>/RTOS-ON-STM32F446RE.git
```
...
3. Browse to any experiment folder (e.g. `EXP1`)
4. Click **Finish**
